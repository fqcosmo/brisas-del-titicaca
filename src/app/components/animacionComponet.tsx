            ...
            <div className="h-full w-full flex flex-col items-center justify-center gap-16">
                ...
                <div className='w-full grid grid-cols-2  justify-between items-center'>
                    <div className='flex flex-col gap-3 items-center justify-center' onMouseEnter={() => setStyle2(1)} onMouseLeave={() => setStyle2(0)}>
                        ...
                        <div className='text-2xl px-14 py-4 rounded-full text-[#FFEC00] border-2 border-[#FFEC00] cursor-pointer transition-all duration-300 hover:shadow-[0_0_10px_#f7e70f,inset_0_0_2px_#FFEC00,0_0_5px_#FFEC00,0_0_15px_#FFEC00,0_0_30px_#FFEC00] hover:bg-[#FFEC00] hover:text-white'>Reserva</div>
                    </div>
                    ...
                    <div className='flex flex-col gap-3 items-center justify-center' onMouseEnter={() => setStyle2(2)} onMouseLeave={() => setStyle2(0)}>
                        ...
                        <div className='text-2xl px-14 py-4 rounded-full text-[#c36] border-2 border-[#c36] cursor-pointer transition-all duration-300 hover:shadow-[0_0_10px_#e64077,inset_0_0_2px_#c36,0_0_5px_#c36,0_0_15px_#c36,0_0_30px_#c36] hover:bg-[#c36] hover:text-white'>Reserva</div>
                    </div>
                </div>
                <div className='text-xl text-white px-10 py-2 border-2 rounded-full cursor-pointer transition-all duration-300 hover:shadow-[0_0_10px_#fff,inset_0_0_2px_#fff,0_0_5px_#fff,0_0_15px_#fff,0_0_30px_#fff] hover:text-white'>Agenda semanal</div>
